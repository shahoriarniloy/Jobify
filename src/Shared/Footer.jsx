            ...
            <nav>
              ...
              <ul>
                <Link to="/advanced-search">
                  <li>
                    <p className="link link-hover text-gray-400">Apply Job</p>
                  </li>
                </Link>
                <Link to="/companies">
                  <li>
                    <p className="link link-hover text-gray-400">
                      Find Company
                    </p>
                  </li>
                </Link>
                <Link to="/messages">
                  <li>
                    <p className="link link-hover text-gray-400">Messaging</p>
                  </li>
                </Link>
                <Link to="/find-job-seekers">
                  <li>
                    <p className="link link-hover text-gray-400">Network</p>
                  </li>
                </Link>
