...
const Login = ({ setLoginModalOpen, setSignUpModalOpen }) => {
  ...
  return (
    ...
    <div
      className={
        theme === "dark"
          ? "bg-[#1A202C] text-white w-[400px] max-w-2xl rounded-lg"
          : "bg-white text-black w-[400px] max-w-2xl  rounded-lg"
      }
    >
      <Helmet>
        <title>{t("login")}</title>
      ...
      <div className="p-7">
        <h2
          className={
            theme === "dark"
              ? "text-4xl font-semibold text-slate-200 text-center "
              : "text-4xl font-semibold text-black text-center "
          }
        >
          {t("sign_in")}
        </h2>{" "}
          ...
          <form onSubmit={handleLogin}>
            ...
            <div className="mt-6">
              <button
                className={
                  theme === "dark"
                    ? "btn w-full bg-blue-600 hover:bg-blue-700 text-white border-none outline-none"
                    : "btn w-full bg-[#0A65CC] hover:bg-blue-500 text-white border-none outline-none"
                }
              >
