...
const CompanyDetails = () => {
  ...
  const handelSendMassage = async () => {
    const { data } = await axiosSecure.post(
      `/send-massage?senderId=${currentUser?.email}&receiverId=${company?.email}`,
      { massage, smsSender: currentUser?.email }
    );
      ...
      <div className="relative container mx-auto">
        <div className="relative">
          ...
          <div
            className={
              theme === "dark"
                ? "container absolute left-1/2 transform -translate-x-1/2 md:-bottom-16 bg-slate-900 rounded-lg shadow-lg p-4 md:p-6 lg:p-8 w-11/12 md:w-3/4 lg:w-1/2"
                : "container absolute left-1/2 transform -translate-x-1/2 md:-bottom-16 bg-white rounded-lg shadow-lg p-4 md:p-6 lg:p-8 w-11/12 md:w-3/4 lg:w-1/2"
            }
          >
        ...
        <div className="flex flex-col lg:flex-row  md:mb-16 gap-12 justify-between md:mt-20">
          <div className="lg:w-1/2 mt-12">
            <h2
              className={
                theme === "dark"
                  ? "font-bold lg:mt-2 text-gray-300 text-xl md:text-2xl lg:text-3xl"
                  : "font-bold lg:mt-2 text-xl md:text-2xl lg:text-3xl"
              }
            >
              {t("description")}
            </h2>
            <p
              className={
                theme === "dark" ? "text-gray-300 mb-4" : "text-gray-500 mb-4"
              }
            >
            ...
            <ul
              className={
                theme === "dark"
                  ? "list-disc text-gray-300 mb-4 "
                  : "list-disc text-gray-500 mb-4"
              }
            >
              <li>{t("benefit_1")}</li>
              <li>{t("benefit_2")}</li>
          ...
          <div className="lg:w-1/2">
            ...
            <div
              className={`p-4 md:p-8 border-2 rounded-lg grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-6 md:gap-10 mt-8 ${
            ...
            <div
              className={
                theme === "dark"
                  ? "p-4 md:p-8 border-2 border-slate-600 rounded-lg md:my-6"
                  : "p-4 md:p-8 border-2 rounded-lg md:my-6"
              }
            >
